...
description: |
  Watch entry health signals; propose status changes and supersede edges when conflicts arise. Phase 5: drafts only.
load_order:
  - role_definition.md
  - personality.yaml
  - operations.yaml
...
Owned domains: **status / relations (conflict resolution & supersede)**
